...
index 83fba70b1c428d30a9cc830a9f884abbad28bc6d..a0dbb4ec7cccf7a398c7eab971f8e016db4aca70 100644
--- a/js/data.js
+++ b/js/data.js
@@ -1,1045 +1,1065 @@
-════════════════════════════════════════════════════════════
...
+    lucas:   { name: "Prof. Lucas",  emoji: "👨‍🏫", color: "#42A5F5", desc: "Guia das missões" },
+    flora:   { name: "Flora",        emoji: "🌱", color: "#66BB6A", desc: "Guia da cidade sustentável" },
+    tina:    { name: "Tina Coop",    emoji: "🤝", color: "#26A69A", desc: "Guia da cooperação e poupança" },
+    leo:     { name: "Léo Faz",      emoji: "🛠️", color: "#FFA726", desc: "Guia do empreendedorismo" }
   },
- 
+
   // ── LUGARES ──────────────────────────
...
+    { id: 1, name: "Planejamento",        icon: "🗓️", place: "home",   color: "#FFD54F", book: "Margô e Davi foram ao mercadinho" },
+    { id: 2, name: "Custo-benefício",     icon: "⚖️", place: "school", color: "#81C784", book: "Margô e Davi foram ao mercadinho" },
+    { id: 3, name: "Renda e orçamento",   icon: "💰", place: "market", color: "#FFB74D", book: "Miguel, Aninha e Dedé ganharam um dinheirinho" },
+    { id: 4, name: "Consumo consciente",  icon: "🛒", place: "coop",   color: "#4FC3F7", book: "Miguel, Aninha e Dedé ganharam um dinheirinho" },
+    { id: 5, name: "Sustentabilidade",    icon: "🌱", place: "park",   color: "#CE93D8", book: "Marina esqueceu de desligar a televisão" }
   ],
- 
+
   // ── CONQUISTAS ───────────────────────
...
+    { id: "first_mission",  icon: "🌟", title: "Selo Primeira Missão", desc: "Completou a primeira missão", coins: 5  },
+    { id: "saver",          icon: "🐷", title: "Selo Poupador",        desc: "Guardou 50 moedas",           coins: 10 },
+    { id: "wise_shopper",   icon: "🛒", title: "Selo Compra Esperta",  desc: "Fez boa escolha no mercado",  coins: 8  },
+    { id: "eco_hero",       icon: "🌱", title: "Selo Guardião Verde",  desc: "Completou trilha consciente", coins: 15 },
+    { id: "dreamer",        icon: "🌈", title: "Selo Sonhador",        desc: "Definiu seu primeiro sonho",  coins: 5  },
+    { id: "good_manners",   icon: "🤝", title: "Selo Boas Maneiras",   desc: "Cumpriu uma missão de casa aprovada pelo responsável", coins: 5 },
+    { id: "trail1",         icon: "🗓️", title: "Selo Planejador",      desc: "Trilha de planejamento completa!", coins: 20 },
+    { id: "trail2",         icon: "⚖️", title: "Selo Custo-benefício", desc: "Trilha de custo-benefício completa!", coins: 20 },
+    { id: "trail3",         icon: "💰", title: "Selo Empreendedor",    desc: "Trilha de renda e orçamento completa!", coins: 20 },
+    { id: "trail4",         icon: "🛒", title: "Selo Consumo Consciente", desc: "Trilha de consumo consciente completa!", coins: 20 },
+    { id: "trail5",         icon: "🌱", title: "Selo Sustentabilidade", desc: "Trilha de sustentabilidade completa!", coins: 30 }
   ],
- 
+
   // ── RECOMPENSAS DA LOJA ──────────────
...
+  ],
+
+  // ── MISSÕES DE CASA (APROVAÇÃO DOS RESPONSÁVEIS) ──
+  homeTasks: [
+    { id: "organizar_mochila", icon: "🎒", title: "Organizei minha mochila", reward: 4, skill: "planejamento" },
+    { id: "guardar_moeda", icon: "🐷", title: "Guardei uma moeda ou parte da mesada", reward: 6, skill: "poupança" },
+    { id: "ajudar_casa", icon: "🤝", title: "Ajudei em uma tarefa de casa", reward: 5, skill: "boas maneiras" },
+    { id: "desligar_luz", icon: "💡", title: "Desliguei luz/TV quando não usei", reward: 5, skill: "sustentabilidade" }
+  ],
+
+  gradeSkills: {
+    "1": "Planejamento com Margô e Davi",
+    "2": "Custo-benefício com Margô e Davi",
+    "3": "Renda e orçamento com Miguel, Aninha e Dedé",
+    "4": "Consumo consciente com Miguel, Aninha e Dedé",
+    "5": "Sustentabilidade com Marina"
+  }
 };
- 
+
